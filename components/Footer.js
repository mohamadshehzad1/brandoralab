            ...
            <div className="px-4 z-40 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                      ...
                      />
                        ...
                        <div className="mt-4 lg:max-w-sm">
                            <p className="text-sm text-white">
                                At Brandora Lab, we are dedicated to transforming your digital vision into reality. Our expert team ensures your business stands out in the digital landscape.
                            </p>
                    ...
                    <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                        <div>
                            ...
                            <ul className="mt-2 space-y-2">
                                ...
                                <li>
                                    <Link href="/all-blogs" className="transition-colors hover:underline cursor-pointer duration-300 text-white hover:text-teal-accent-400">
                                        Blogs
                                    </Link>
                                </li>
                                <li>
                ...
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
                    <p className="text-sm text-gray-100">
                        © Copyright 2024 Brandora Lab. All rights reserved.
                    </p>

                    <div className="flex items-center mt-4 space-x-4 sm:mt-0">
                        <Link
                            href="https://web.facebook.com/Brandora Lab"
                            className="transition-colors duration-300 text-white hover:text-teal-accent-400"
                        >
                        ...
                        <Link
                            href="https://www.instagram.com/Brandora Lab/"
                            className="transition-colors duration-300 text-white hover:text-teal-accent-400"
                        >
                            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
                ...
                M12,16.3c-2.4,0-4.3-1.9-4.3-4.3c0-2.4,1.9-4.3,4.3-4.3c2.4,0,4.3,1.9,4.3,4.3C16.3,14.4,14.4,16.3,12,16.3L12,16.3z"/>
                        ...
                        <Link
                            href="https://www.youtube.com/@Brandora Lab"
                            className="transition-colors duration-300 text-white hover:text-teal-accent-400"
                        >
                            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
