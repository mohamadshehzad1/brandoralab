        ...
        <div className="max-w-5xl mb-10 mx-auto lg:mt-10 hidden md:block ">
            <div className="grid grid-cols-1 lg:grid-cols-2 ">
                ...
                <div>
                    <div className="relative mx-auto mb-7 lg:mb-0 p-5">
                        ...
                        <h2 className="block w-full text-center lg:text-start text-black font-bold text-3xl sm:text-4xl">
                            Stay Connected with Brandora Lab
                        </h2>
                        <p className="mx-auto my-4 w-full text-center lg:text-start max-w-xl bg-transparent font-medium leading-relaxed tracking-wide text-gray-400">
                            Join us on Facebook to get the latest updates, news, and insights from Brandora Lab. We share valuable content on web development, SEO, and digital marketing that can help you take your projects to the next level.
                        </p>
                    </div>
                </div>
                ...
                <div className="relative mx-auto  ">
                    {isClient && (
                        <iframe
                            src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FBrandora Lab&tabs=timeline&width=1000&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
