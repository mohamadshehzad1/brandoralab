                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <h1 className="text-4xl font-bold tracking-tight text-black sm:text-5xl md:text-6xl">
                                        <span className="sm:text-6xl"></span> Brandora Lab 
                                ...
                                <p className="text-gray-700">
                                    At Brandora Lab, we are committed to your success. Our courses are designed to provide you with the skills and knowledge needed to excel in your career.
