    ...
    <div>
      ...
      <div className="relative px-6 mt-10 mb-10 md:mt-20 mx-auto max-w-5xl text-center">
        ...
        <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-400">
          At Brandora Lab, we offer reliable and high-performance web hosting services to ensure your websites run smoothly and efficiently. Discover our range of hosting plans designed to meet your specific needs.
        </p>
      </div>
