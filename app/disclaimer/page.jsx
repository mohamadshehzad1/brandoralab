    ...
    return (
        <div className=" min-h-screen">
            ...
            <div className="relative px-6 mt-10 mb-10 md:mt-20 mx-auto max-w-4xl bg-white">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                    Therefore, while we make every effort to ensure the accuracy of the information provided and the effectiveness of our services, <strong>Brandora Lab</strong> cannot guarantee specific results. We encourage our clients to engage in thorough research and due diligence prior to making decisions based on the information and recommendations we provide.
                </p>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                    Brandora Lab shall not be liable for any direct, indirect, incidental, or consequential damages that may arise from the use of our services, or reliance on the information provided on our website or through our communications. By utilizing our services, you acknowledge that you have read, understood, and agree to this disclaimer.
                </p>
