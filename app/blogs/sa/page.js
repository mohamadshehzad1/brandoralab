import { blogData } from '@/content/blogs/sa'
...
export const metadata = {
  title: "مدونة السعودية | BrandoraLab",
  description: "اقرأ أحدث المقالات حول استضافة المواقع، ووردبريس، والأدوات الرقمية باللغة العربية.",
  alternates: {
    canonical: "https://yourdomain.com/blogs/sa",
  },
}
const BlogsPage = () => {
  return (
    ...
    <div className="pt-10">
      ...
      <h1 className="text-5xl font-bold mb-6 text-center">مدوناتنا</h1>
